...
#pragma default_function_attributes =@".SpecFunctionLocation"
...
//	DMA_InitStructure.DMA_PeripheralBaseAddr = &USART1->RDR;
//	DMA_InitStructure.DMA_BufferSize = (uint16_t)BUFFERSIZE;
//	DMA_InitStructure.DMA_MemoryBaseAddr = (uint32_t)aRxBuffer;
